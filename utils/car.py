...
class SimpleCar:
    ...
    def get_car_state(self, pos, phi=0):
        ...
        model = [
            ...
            Rectangle(self.w1, width=self.whll, height=self.whlw, angle=degrees(theta+phi), fc='k', ec='k'),
            Rectangle(self.w2, width=self.whll, height=self.whlw, angle= degrees(theta+phi), fc='k', ec='k'),
            Rectangle(self.w3, width=self.whll, height=self.whlw, angle= degrees(theta), fc='k', ec='k'),
            Rectangle(self.w4, width=self.whll, height=self.whlw, angle= degrees(theta), fc='k', ec='k'),
